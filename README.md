...
- **[agent-platform](https://github.com/teo-devops/agent-platform)** — Agentes declarativos (un agent.yaml) sobre ADK, LangGraph y LangChain; MCP, A2A, kagent y MLflow como backend de AgentOps
- **[mlops-ct-platform](https://github.com/teo-devops/mlops-ct-platform)** — Tool-agnostic MLOps platform demonstrating a closed continuous-training loop on kind (GitOps, registry, serving, drift-driven retraining)
...
| 📈 **MLOps** | 7 | [lista](https://github.com/stars/teo-devops/lists/mlops) · [topic](https://github.com/search?q=user%3Ateo-devops%20topic%3Aarea-mlops&type=repositories) |
...
| 🏗️ **IaC** | 1 | [lista](https://github.com/stars/teo-devops/lists/iac) · [topic](https://github.com/search?q=user%3Ateo-devops%20topic%3Aarea-iac&type=repositories) |
| 🧪 **Testing** | 3 | [lista](https://github.com/stars/teo-devops/lists/testing) · [topic](https://github.com/search?q=user%3Ateo-devops%20topic%3Aarea-testing&type=repositories) |

<details>
<summary><b>🌐 Dataspaces</b> — 2 repos</summary>
...
y un escenario MVD reproducible sobre KinD y Argo CD con dos vías de datos (Envoy Gateway PULL,
Bento PUSH) que hablan Data Plane Signaling.

| Repo | Stack | Qué es |
|---|---|---|
| [Connector](https://github.com/teo-devops/Connector) *(fork)* | `eclipse-edc` · `java` | Fork de eclipse-edc/Connector con la base congelada en freeze/v1.0.0-RC1-1: versión derivada del tag de git, autodoc y firma adaptados |
| [IdentityHub](https://github.com/teo-devops/IdentityHub) *(fork)* | `eclipse-edc` · `java` | Fork de eclipse-edc/IdentityHub con la base congelada en freeze/v1.0.0-RC1-1: misma derivación de versión que el Connector |
...
<details>
<summary><b>📈 MLOps</b> — 7 repos</summary>

| Repo | Stack | Qué es |
|---|---|---|
| [agent-platform](https://github.com/teo-devops/agent-platform) | `a2a` · `agentops` · `ai-agents` | Agentes declarativos (un agent.yaml) sobre ADK, LangGraph y LangChain; MCP, A2A, kagent y MLflow como backend de AgentOps |
...
| [mlops-ct-platform](https://github.com/teo-devops/mlops-ct-platform) | `argo-workflows` · `argocd` · `continuous-training` | Tool-agnostic MLOps platform demonstrating a closed continuous-training loop on kind (GitOps, registry, serving, drift-driven retraining) |
...
| Repo | Stack | Qué es |
|---|---|---|
| [Jenkins](https://github.com/teo-devops/Jenkins) *(fork)* | `ci-cd` · `jenkins` · `testing` | Proyecto DevOps and Cloud (UNIR): unit, service y performance testing en pipeline Jenkins |
...
| [nginx-crash-course](https://github.com/teo-devops/nginx-crash-course) | `load-balancing` · `nginx` · `reverse-proxy` | Curso practico de Nginx: reverse proxy, load balancing y TLS |
...
<sub>Índice generado por <code>scripts/generar_readme.py</code> desde los topics <code>area-*</code> de cada repo. No se edita a mano.</sub>
